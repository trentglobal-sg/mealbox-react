            ...
            <React.Fragment>
                ...
                <div className="container">
                    ...
                    <div className="filter-bar">
                        <input type="text" className="form-control my-1 mr-sm-2" name="search-field" placeholder="Search Recipe Name" />
                        <select className="form-control cuisine-bar my-1 mr-sm-2" name="cuisine_type" value={this.state.cuisine_type}>
                        ...
                        <select className="form-control difficulty-bar my-1 mr-sm-2" name="difficulty" value={this.state.cuisine_type} >
